...
public struct Signal_SignalMessage {
...
public struct Signal_PreKeySignalMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Signal_SenderKeyMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Signal_SenderKeyDistributionMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Signal_SignalMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    static public let protoMessageName: String = _protobuf_package + ".SignalMessage"
    ...
    public func _protobuf_generated_isEqualTo(other: Signal_SignalMessage) -> Bool {
...
extension Signal_PreKeySignalMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    static public let protoMessageName: String = _protobuf_package + ".PreKeySignalMessage"
    static public let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    public func _protobuf_generated_isEqualTo(other: Signal_PreKeySignalMessage) -> Bool {
...
extension Signal_SenderKeyMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    static public let protoMessageName: String = _protobuf_package + ".SenderKeyMessage"
    static public let _protobuf_nameMap: SwiftProtobuf._NameMap = [
        1: .same(proto: "id"),
    ...
    public func _protobuf_generated_isEqualTo(other: Signal_SenderKeyMessage) -> Bool {
...
extension Signal_SenderKeyDistributionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    static public let protoMessageName: String = _protobuf_package + ".SenderKeyDistributionMessage"
    static public let _protobuf_nameMap: SwiftProtobuf._NameMap = [
        1: .same(proto: "id"),
        2: .same(proto: "iteration"),
    ...
    public func _protobuf_generated_isEqualTo(other: Signal_SenderKeyDistributionMessage) -> Bool {
        if self._id != other._id {return false}
        if self._iteration != other._iteration {return false}
