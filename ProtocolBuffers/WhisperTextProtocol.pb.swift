...
struct Textsecure_SignalMessage: SwiftProtobuf.Message {
...
struct Textsecure_PreKeySignalMessage: SwiftProtobuf.Message {
...
struct Textsecure_KeyExchangeMessage: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".KeyExchangeMessage"
...
struct Textsecure_SenderKeyMessage: SwiftProtobuf.Message {
...
struct Textsecure_SenderKeyDistributionMessage: SwiftProtobuf.Message {
...
struct Textsecure_DeviceConsistencyCodeMessage: SwiftProtobuf.Message {
...
extension Textsecure_SignalMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_SignalMessage) -> Bool {
...
extension Textsecure_PreKeySignalMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_PreKeySignalMessage) -> Bool {
...
extension Textsecure_KeyExchangeMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "baseKey"),
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_KeyExchangeMessage) -> Bool {
...
extension Textsecure_SenderKeyMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_SenderKeyMessage) -> Bool {
    if self._id != other._id {return false}
...
extension Textsecure_SenderKeyDistributionMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "iteration"),
  ...
  func _protobuf_generated_isEqualTo(other: Textsecure_SenderKeyDistributionMessage) -> Bool {
    if self._id != other._id {return false}
    if self._iteration != other._iteration {return false}
...
extension Textsecure_DeviceConsistencyCodeMessage: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "generation"),
    2: .same(proto: "signature"),
  ]

  func _protobuf_generated_isEqualTo(other: Textsecure_DeviceConsistencyCodeMessage) -> Bool {
