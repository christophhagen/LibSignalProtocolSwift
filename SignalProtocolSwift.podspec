#
#  Be sure to run `pod spec lint SignalProtocolSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Christoph Hagen" => "christoph@spacemasters.eu" }
  # s.social_media_url   = "http://twitter.com/Christoph Hagen"
  ...
  s.source_files  = "SignalProtocolSwift/**/*.{swift}"
  ...
  s.dependency "CommonCryptoModule", :git => 'https://github.com/christophhagen/CommonCryptoModule.git'
